...
CREATE TABLE `quartier` (
  ...
  `nom_quartier` varchar(255) DEFAULT NULL,
  PRIMARY KEY (`id_quartier`),
  KEY `FKsgn0pk5kk9ymyq8ylm2uk1mg5` (`id_ville`),
  CONSTRAINT `FKsgn0pk5kk9ymyq8ylm2uk1mg5` FOREIGN KEY (`id_ville`) REFERENCES `ville` (`id_ville`)
...
INSERT INTO `quartier` VALUES (NULL,1,1,NULL,'Hassan'),(NULL,2,1,NULL,'Agdal');
